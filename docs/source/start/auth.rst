...
Once a :doc:`project is set up <setup>`, you will still have to follow a few steps before you can actually use pyroblack to make
...
pyroblack automatically manages this process, all you need to do is create an instance of the
...
After successfully authorizing yourself, a new file called ``my_account.session`` will be created allowing pyroblack to
...
:doc:`configure a Telegram API key <../start/setup>` with pyroblack, even when using bots.
