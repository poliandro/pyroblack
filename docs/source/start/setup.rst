...
We have just :doc:`installed pyroblack <../intro/install>`. In this page we'll discuss what you need to do in order to set up a
...
Having the API key from the previous step in handy, we can now begin to configure a pyroblack project: pass your API key to pyroblack by using the *api_id* and *api_hash* parameters of the Client class:
