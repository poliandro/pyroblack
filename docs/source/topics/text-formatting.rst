...
pyroblack uses a custom Markdown dialect for text formatting which adds some unique features that make writing styled
...
list of the basic styles currently supported by pyroblack.
