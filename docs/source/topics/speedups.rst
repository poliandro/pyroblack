...
pyroblack's speed can be boosted up by using TgCrypto and uvloop.
...
TgCrypto_ is a high-performance, easy-to-install cryptography library specifically written in C for pyroblack as a Python
...
pyroblack will automatically make use of TgCrypto when detected, all you need to do is to install it.
