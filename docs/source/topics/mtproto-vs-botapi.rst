...
pyroblack is a framework written from the ground up that acts as a fully-fledged Telegram client based on the MTProto
API. This means that pyroblack is able to execute any official client and bot API action and more. This page will
therefore show you why pyroblack might be a better choice for your project by comparing the two APIs, but first, let's
...
pyroblack, implement all these details.
...
Here is a non-exhaustive list of all the advantages in using MTProto-based libraries -- such as pyroblack -- instead of
the official HTTP Bot API. Using pyroblack you can:
